"""
Figure: DCT Energy Spectrum — Step 0 vs Step 512
=================================================

Overlays the mean DCT energy spectrum at step 0 (init) and step 512
for a given model, highlighting the early spectral shift.
...
OUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "spectrum_0_vs_512")
...
if __name__ == "__main__":
    for key in MODELS:
        ...
        save(fig, f"fig_spectrum_0_vs_512_{key}", out_dir=OUT_DIR)
        plt.close(fig)
